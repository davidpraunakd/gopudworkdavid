...
// function change(){
        ...
        echo color("blue","\n▬▬▬▬▬▬▬▬▬▬▬▬▶️REDEM TAPI JANGAN DI SEKIP BANG▶️▬▬▬▬▬▬▬▬▬▬▬▬");
        echo "\n".color("nevy","🦴🦴DAVID 1");
        ...
        $code1 = request2('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"STAYGOFOOD201105SCE"}');
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("green","🦴Message: ".$message);
        ...
        sleep(5);
        $boba09 = request1('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"STAYGOFOOD201105SCE"}');
